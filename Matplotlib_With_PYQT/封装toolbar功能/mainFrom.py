...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        #  设置button的状态ToolTip和StatusTipt
        self.set_button_tip(self.save_pushButton, '点击保存 快捷键Ctrl + S')
        self.set_button_tip(self.reset_Button, '显示图像最初的样子')

        self.set_button_tip(self.forward_Button, '返回上一步图像')
        self.set_button_tip(self.back_Button, '返回下一步图像')
        self.set_button_tip(self.zoom_pushButton, '选中 鼠标左键放大图像， 鼠标右键缩小图像')
        self.set_button_tip(self.pan_pushButton, '选中图像 可拖动查看细节')
