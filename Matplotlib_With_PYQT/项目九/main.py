...
class MinWindow(Winform):
    ...
    def toolbar_zoom(self):
        # 放大当前图像
        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.zoom()

    def toolbar_back(self):
        # 显示前一步操作的图像
        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.back()

    def toolbar_edit_parameters(self):
        # 编辑图像的参数

        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.edit_parameters()

    def toolbar_pan(self):
        #
        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.pan()

    def toolbar_edit_parameters(self):
        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.edit_parameters()

    def toolbar_home(self):
        self.stack_tabWidget.currentWidget().mpl_nav_toolbar.home()
    ...
    def add_button(self):
        ...
        self.plot_button = QtWidgets.QPushButton('重置',self.centralwidget, )
        self.plot_button.setGeometry(QtCore.QRect(750, 160, 75, 23))
        self.plot_button.setObjectName("plot_button")

        # toolbar 区域隐藏NavigationToolbar
        # 添加自己包装的功能按钮
        # 五个按钮
        layout = QHBoxLayout()

        # self.plot_button = QtWidgets.QPushButton('重置')
        # btnlayout = QtWidgets.QHBoxLayout()
        # btnlayout.addWidget(self.plot_button)
        # self.toolbar_stackedWidget.addWidget(self.plot_button)
        # self.toolbar_page1 = btnlayout
        # # self.stack_tabWidget.currentWidget().mpl_nav_toolbar._reset()
        # self.save_pushButton.clicked.connect(self.stack_tabWidget.currentWidget().mpl_nav_toolbar.zoom)
        ...
        # back_button = QtWidgets.QPushButton('向后')
        # self.back_button.clicked.connect(self.zoom)
        # #
        # forward_button = QtWidgets.QPushButton('向前')
        # self.button3.clicked.connect(self.pan)
        #
        # pan_button = QtWidgets.QPushButton('选中')
    ...
    def events_all_siganl_connect(self):
        ...
        # 点击按钮 保存当前图像
        self.save_pushButton.clicked.connect(self.toolbar_save_plot)
